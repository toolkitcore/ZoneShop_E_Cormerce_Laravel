                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <p class="text-dark fw-medium fs-15 mb-0">{{$brand->brand_name}}</p>
                                            </div>
                                        ...
                                        <td class="truncate" style="max-width: 100px;
                                                                    white-space: nowrap;
                                                                    overflow: hidden;
                                                                    text-overflow: ellipsis;">{{$brand->brand_desc}}</td>
                                        <td>
                                            <?php
                                            if ($brand->brand_status == 0) {
                                            ?>
                                                <a href="{{URL::to('/active-brand-product/'.$brand->brand_id)}}" class="btn btn-light btn-sm">
                                                    <iconify-icon icon="solar:eye-broken" class="align-middle fs-18"></iconify-icon>
                                                </a>
                                            <?php
                                            } else {
                                            ?>
                                                <a href="{{URL::to('/unactive-brand-product/'.$brand->brand_id)}}" class="btn btn-primary btn-sm">
                                                    <iconify-icon icon="solar:eye-broken" class="align-middle fs-18"></iconify-icon>
                                                </a>
                                            <?php
                                            }
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <!-- EDIT brand -->
                                                <a href="{{URL::to('/edit-brand-product/'.$brand->brand_id)}}" class="btn btn-soft-primary btn-sm">
                                                    <iconify-icon icon="solar:pen-2-broken" class="align-middle fs-18"></iconify-icon>
                                                </a>
                                                <!-- DELETE brand -->
                                                <a href="{{URL::to('/delete-brand-product/'.$brand->brand_id)}}" onclick="return confirm('Are you sure to delete This')" class="btn btn-soft-danger btn-sm"><iconify-icon icon="solar:trash-bin-minimalistic-2-broken" class="align-middle fs-18"></iconify-icon></a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
