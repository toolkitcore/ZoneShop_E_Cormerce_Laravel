                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" value="{{ $brand_item->brand_name }}"
                                                    name="brand_name" id="brand-title" class="form-control"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-0">
                                                ...
                                                <textarea class="form-control bg-light-subtle" id="description" name="brand_desc" rows="7"
                                                    placeholder="Type description">{{ $brand_item->brand_desc }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-end g-2">
                                    <div class="col-lg-2">
                                        <button type="submit" name="add_brand"
                                            class="btn btn-outline-secondary w-100">Update Brand</button>
                                    </div>
                                    <div class="col-lg-2">
