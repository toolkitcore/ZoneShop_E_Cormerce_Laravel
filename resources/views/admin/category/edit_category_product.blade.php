...
<div class="page-content">
    ...
    <div class="container-xxl">
        <div class="row">
            ...
            <form action="{{URL::to('/update-category-action/'.$category_item->category_id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                ...
                                ?>
                                    <img id="imagePreview" src="{{URL::to('public/uploads/category/'.$category_item->category_image) }}" alt="{{'uploads/category/'.$category_item->category_image }}" width="300" />
                                <?php
                                } else {
                                ?>
                                    <img id="imagePreview" src="{{'public/uploads/category/'.$category_item->category_image}}" alt="{{'public/uploads/category/'.$category_item->category_image}}" style="display: none; max-width:300px;" />
                                <?php
                                }
                                ?>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{$category_item->category_name}}" name="category_name" id="category-title" class="form-control" placeholder="Enter Title">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-0">
                                        ...
                                        <textarea class="form-control bg-light-subtle" id="description" name="category_desc" rows="7" placeholder="Type description">{{$category_item->category_desc}}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-0">
                                        ...
                                        <input type="number" class="form-control " name="category_sort_order" id="" min=1
                                            value="{{$category_item->category_sort_order}}">
                                    </div>
                                </div>
                    ...
                    <div class="p-3 bg-light mb-3 rounded">
                        <div class="row justify-content-end g-2">
                            <div class="col-lg-2">
                                <button type="submit" name="add_category" class="btn btn-outline-secondary w-100">Update Category</button>
                            </div>
                            <div class="col-lg-2">
