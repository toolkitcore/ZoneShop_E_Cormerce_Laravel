                            ...
                            <div class="mt-4 pt-3">
                                ...
                                <div class="mt-2">
                                    ...
                                    <p class="fs-15 mb-1 mt-1"><span class="text-dark fw-semibold">Email : </span>
                                        {{ $user->email }}</p>
                                    {{-- <p class="fs-15 mb-0 mt-1"><span class="text-dark fw-semibold">Phone : </span> +28
                                        (57) 760-010-27</p> --}}
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-dark fw-medium px-0">62, rue des Nations Unies 22000
                                                SAINT-BRIEUC</td>
                                        </tr>
                                        <tr>
                                            <td class="px-0">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                            <h4 class="card-title mb-2 d-flex align-items-center gap-2">Total Invoice
                                            </h4>
                                            <p class="text-muted fw-medium fs-22 mb-0">{{ $total_invoice }}</p>
                                        </div>
                                        <div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                            <h4 class="card-title mb-2 d-flex align-items-center gap-2">Total Order
                                            </h4>
                                            <p class="text-muted fw-medium fs-22 mb-0">{{ $total_order }}</p>
                                        </div>
                                        <div>
                                            <div class="avatar-md bg-primary bg-opacity-10 rounded">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                            <h4 class="card-title mb-2 d-flex align-items-center gap-2">Total Expense
                                            </h4>
                                            <p class="text-muted fw-medium fs-22 mb-0">
                                                {{ number_format($total_expense) . ' VND' }}</p>
                                        </div>
                                        <div>
                                            <div class="avatar-md bg-primary bg-opacity-10 rounded">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="ms-auto">
                                            <span class="text-muted">
                                                <a href="#!" class="link-reset fs-3"><iconify-icon
                                                        icon="solar:settings-bold"></iconify-icon></a>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="mt-4">
                                        <div class="d-flex align-items-center">
                                            <h5 class="text-dark mb-0">All Account <span
                                                    ...
                                                    class="text-muted fw-normal ms-1">Total Balance</span></h5>
                                            <div class="ms-auto">
                                                <a href="#!" class="link-reset fw-medium">UTS <i
