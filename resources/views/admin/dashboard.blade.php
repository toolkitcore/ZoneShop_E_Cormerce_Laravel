                ...
                <div class="card card-height-100">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-nowrap table-centered m-0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="ps-3"><a href="#" class="text-muted">ZoneShop/ecommerce.html</a></td>
                                    <td>465 </td>
                                    <td><span class="badge badge-soft-success">4.4%</span></td>
                                </tr>
                                <tr>
                                    <td class="ps-3"><a href="#" class="text-muted">ZoneShop/dashboard.html</a></td>
                                    <td> 426</td>
                                    <td><span class="badge badge-soft-danger">20.4%</span></td>
                                </tr>
                                <tr>
                                    <td class="ps-3"><a href="#" class="text-muted">ZoneShop/chat.html</a></td>
                                    <td>254 </td>
                                    <td><span class="badge badge-soft-warning">12.25%</span></td>
                                </tr>
                                <tr>
                                    <td class="ps-3"><a href="#" class="text-muted">ZoneShop/auth-login.html</a></td>
                                    <td> 3369</td>
                                    <td><span class="badge badge-soft-success">5.2%</span></td>
                                </tr>
                                <tr>
                                    <td class="ps-3"><a href="#" class="text-muted">ZoneShop/email.html</a></td>
                                    <td>985 </td>
                                    <td><span class="badge badge-soft-danger">64.2%</span></td>
                                </tr>
                                <tr>
                                    <td class="ps-3"><a href="#" class="text-muted">ZoneShop/social.html</a></td>
                                    <td>653 </td>
                                    <td><span class="badge badge-soft-success">2.4%</span></td>
                                </tr>
                                <tr>
                                    <td class="ps-3"><a href="#" class="text-muted">ZoneShop/blog.html</a></td>
                                    <td>478 </td>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>29 April 2024</td>
                                    <td>
                                        <img src="{{('public/BackEnd/images/products/product-1(1).png')}}" alt="product-1(1)" class="img-fluid avatar-sm">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>25 April 2024</td>
                                    <td>
                                        <img src="{{('public/BackEnd/images/products/product-4.png')}}" alt="product-4" class="img-fluid avatar-sm">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>25 April 2024</td>
                                    <td>
                                        <img src="{{('public/BackEnd/images/products/product-5.png')}}" alt="product-5" class="img-fluid avatar-sm">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>21 April 2024</td>
                                    <td>
                                        <img src="{{('public/BackEnd/images/products/product-6.png')}}" alt="product-6" class="img-fluid avatar-sm">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>18 April 2024</td>
                                    <td>
                                        <img src="{{('public/BackEnd/images/products/product-1(2).png')}}" alt="product-1(2)" class="img-fluid avatar-sm">
                                    </td>
                                    <td>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    </script> &copy; ZoneShop. Crafted by <iconify-icon icon="iconamoon:heart-duotone" class="fs-18 align-middle text-danger"></iconify-icon> <a
