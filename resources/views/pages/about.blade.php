                ...
                <div class="team-slide-activation slick-layout-wrapper--20 axil-slick-arrow  arrow-top-slide">
                    <div class="slick-single-layout">
                        <div class="axil-team-member">
                            <div class="thumbnail"><img src="{{asset('public/BackEnd/images/team/team-01.png')}}" alt="Cody Fisher"></div>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-team-member">
                            <div class="thumbnail"><img src="{{asset('public/BackEnd/images/team/team-02.png')}}" alt="Cody Fisher"></div>
                            <div class="team-content">
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-team-member">
                            <div class="thumbnail"><img src="{{asset('public/BackEnd/images/team/team-03.png')}}" alt="Cody Fisher"></div>
                            <div class="team-content">
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-team-member">
                            <div class="thumbnail"><img src="{{asset('public/BackEnd/images/team/team-04.png')}}" alt="Cody Fisher"></div>
                            <div class="team-content">
                                <span class="subtitle">Designer</span>
                                <h5 class="title">Alonso M. Miklonax</h5>
                            </div>
        ...
        <div class="row row-cols-xl-4 row-cols-sm-2 row-cols-1 row--20">
            <div class="col">
                <div class="service-box service-style-2">
                    <div class="icon">
                        <img src="{{asset('public/BackEnd/images/icons/service1.png')}}" alt="Service">
                    </div>
                    <div class="content">
            ...
            <div class="col">
                <div class="service-box service-style-2">
                    <div class="icon">
                        <img src="{{asset('public/BackEnd/images/icons/service2.png')}}" alt="Service">
                    </div>
                    <div class="content">
            ...
            <div class="col">
                <div class="service-box service-style-2">
                    <div class="icon">
                        <img src="{{asset('public/BackEnd/images/icons/service3.png')}}" alt="Service">
                    </div>
                    <div class="content">
            ...
            <div class="col">
                <div class="service-box service-style-2">
                    <div class="icon">
                        <img src="{{asset('public/BackEnd/images/icons/service4.png')}}" alt="Service">
                    </div>
                    <div class="content">
